...
#Resampling GMIA 0.01 arc degree to 1 km resolution (no data for Cyprus)
...
def replace_nodata_with_zero(input_tif, output_tif):
...
replace_nodata_with_zero('AEI_share_2010_1km_max_100_2.tif', 'AEI_share_2010_1km_revised_100.tif')
